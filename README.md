...
2. **Vercel'e Deploy**
   ...
   - Environment Variables ekle:
     - `TIKTOK_APP_ID`: 7598110409156984833
     - `TIKTOK_APP_SECRET`: 1c5b38fb69f512a8db47f11067015884c00aed44
   - "Deploy" tıkla
...
- API secret'ları sadece backend'de tutulur
- CORS sadece izinli domain'lere açık
- Rate limiting eklenebilir (production için önerilir)
